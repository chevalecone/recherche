...
//****************************MRT*******************************************//
void MRT_moment(int j, Lattice lat, double** M); // calcul des moments (produit matriciel entre les populations et la matrice de passage)
void MRT_equilibre(int j,Lattice lat, double** M); //calcul des moments d'équilibre 
void MRT_collision( int j, double** f_star, double** C, Lattice  lat,  int Q, double dt); // collision entre les populations en utilisant les moments
...
double** MRT_S(int Q, double nu, double cs, double dt); //Matrice de relaxation
